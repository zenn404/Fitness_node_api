            ...
            case 'Tab':
                if (!allowsTabNavigation) {
                    ...
                    if (e.shiftKey) ref.current.focus();
                        ...
                        if (next && (!next.contains(document.activeElement) || document.activeElement && !(0, $bT8Bh$reactariautils.isTabbable)(document.activeElement))) (0, $bT8Bh$reactariautils.focusWithoutScrolling)(next);
                    }
                    break;
                }
        }
