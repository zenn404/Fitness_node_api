import type { ComponentClass, ComponentProps, ComponentType, ElementType, FunctionComponent, PropsWithChildren, ReactNode } from 'react';
import type { ImageStyle, LayoutChangeEvent, StyleProp, TextStyle, ViewStyle } from 'react-native';
export type ComponentStyle<T extends ElementType> = ComponentProps<T>['style'] extends StyleProp<infer P> ? P : ComponentProps<T>['style'];
